  ...
  return (
    <section id="catalog" className="relative py-24 bg-[var(--graphite)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 mb-24">
          {badges.map((badge) => (
            <div
              key={badge.label}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {lids.map((factory) => (
            <div
              key={factory.factory}
              className="bg-[var(--obsidian)] border border-[rgba(201,168,76,0.15)] rounded-lg overflow-hidden"
            >
